 ...
 * @author   errcodex
 * @brief
 * 6 cases passed on 9/3/2020 with 31ms max time use
 * and 624KB max space use.
 *
 */
#include <algorithm>
#include <iostream>
...
int cmp(const char t1, const char t2);
bool cmp2(const pair<char, int>& p1, const pair<char, int>& p2);
